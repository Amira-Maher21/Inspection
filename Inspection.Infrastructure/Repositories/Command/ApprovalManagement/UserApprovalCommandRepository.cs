...
{
    internal class UserApprovalCommandRepository : CommandRepositoryBase<User_Approval>, IUserApprovalCommandRepository
    {
        public UserApprovalCommandRepository(DbInspectionContext context,
