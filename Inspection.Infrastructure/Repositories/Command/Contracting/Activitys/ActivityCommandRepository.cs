...
namespace Inspection.Infrastructure.Repositories.Command.Contracting.Activitys
{
    public class ActivityCommandRepository : CommandRepositoryBase<Activity>, IActivityCommandRepository
    {
        public ActivityCommandRepository(
            DbContext context,
