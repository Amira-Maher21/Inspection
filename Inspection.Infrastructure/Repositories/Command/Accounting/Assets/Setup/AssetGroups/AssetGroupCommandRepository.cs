...
namespace Inspection.Infrastructure.Repositories.Command.Accounting.Assets.Setup.AssetGroups
{
    public class AssetGroupCommandRepository : CommandRepositoryBase<AssetGroup>,IAssetGroupCommandRepository
    {
        public AssetGroupCommandRepository(DbContext context, ITenantResolver tenantResolver, IExceptionManager exceptionManager) : base(context, tenantResolver, exceptionManager)
        {
