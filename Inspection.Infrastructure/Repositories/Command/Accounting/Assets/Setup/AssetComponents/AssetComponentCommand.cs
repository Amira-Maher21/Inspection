...
namespace Inspection.Infrastructure.Repositories.Command.Accounting.Assets.Setup.AssetComponents
{
    public class AssetComponentCommandRepository : CommandRepositoryBase<AssetComponent>, IAssetComponentCommandRepository
    {
        public AssetComponentCommandRepository(DbContext context, ITenantResolver tenantResolver, IExceptionManager exceptionManager) : base(context, tenantResolver, exceptionManager)
        {
        ...
        public async Task<ReturnBase> DeleteById(long id)
        {
            ...
            if (entity is null)
            {
                ...
                {
                    ErrorCode = "404",
                    ErrorMessage = $"Asset Component with Id '{id}' was not found."
                };
