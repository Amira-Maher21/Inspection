...
{
    public class CustomerGroupCommandRepository : CommandRepositoryBase<CustomerGroup>, ICustomerGroupCommandRepository
    {
        public CustomerGroupCommandRepository(DbContext context, ITenantResolver tenantResolver, IExceptionManager exceptionManager) : base(context, tenantResolver, exceptionManager)
        {
