...
namespace Inspection.Infrastructure.Repositories.Command.SalesManagment.sales
{
    ...
    public class JobOrderDetailCommandRepository : CommandRepositoryBase<JobOrderLine>, IJobOrderDetailCommandRepository
    {
        public JobOrderDetailCommandRepository(DbContext context, ITenantResolver tenantResolver, IExceptionManager exceptionManager) : base(context, tenantResolver, exceptionManager)
        {
