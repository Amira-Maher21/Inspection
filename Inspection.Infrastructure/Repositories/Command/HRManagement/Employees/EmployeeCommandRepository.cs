...
namespace Inspection.Infrastructure.Repositories.Command.HRManagement.Employees
{
    internal class EmployeeCommandRepository : CommandRepositoryBase<Employee>, IEmployeeCommandRepository
    {
        public EmployeeCommandRepository(DbContext context, ITenantResolver tenantResolver, IExceptionManager exceptionManager) : base(context, tenantResolver, exceptionManager)
        {
