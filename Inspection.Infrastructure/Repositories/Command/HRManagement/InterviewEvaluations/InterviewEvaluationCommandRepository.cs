...
namespace Inspection.Infrastructure.Repositories.Command.HRManagement.InterviewEvaluations
{
    internal class InterviewEvaluationCommandRepository : CommandRepositoryBase<InterviewEvaluation>, IInterviewEvaluationCommandRepository
    {
        public InterviewEvaluationCommandRepository(DbContext context, ITenantResolver tenantResolver, IExceptionManager exceptionManager) : base(context, tenantResolver, exceptionManager)
        {
