...
namespace Inspection.Infrastructure.Repositories.Command.HRManagement.Departments
{
    internal class DepartmentCommandRepository : CommandRepositoryBase<Department>, IDepartmentCommandRepository
    {
        public DepartmentCommandRepository(DbContext context, ITenantResolver tenantResolver, IExceptionManager exceptionManager) : base(context, tenantResolver, exceptionManager)
        {
