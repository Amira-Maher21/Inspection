...
{
    public class SalesReturnAdjustmentConfiguration : IEntityTypeConfiguration<SalesReturnAdjustment>
    {
        public void Configure(EntityTypeBuilder<SalesReturnAdjustment> builder)
        {
            builder.ToTable("SalesReturnAdjustment", "Sales");
