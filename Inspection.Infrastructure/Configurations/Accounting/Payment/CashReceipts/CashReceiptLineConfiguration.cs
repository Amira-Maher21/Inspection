...
{
    public class CashReceiptLineConfiguration : IEntityTypeConfiguration<CashReceiptLine>
    {
        public void Configure(EntityTypeBuilder<CashReceiptLine> builder)
        {
            builder.ToTable("CashReceiptLine", "Accounting");
