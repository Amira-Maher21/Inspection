...
{
    internal class CashPaymentAdjustmentConfiguration : IEntityTypeConfiguration<CashPaymentAdjustment>
    {
        public void Configure(EntityTypeBuilder<CashPaymentAdjustment> builder)
        {
            builder.ToTable("CashPaymentAdjustment", "Accounting");
