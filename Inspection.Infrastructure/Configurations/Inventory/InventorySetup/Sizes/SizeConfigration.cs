...
namespace Inspection.Infrastructure.Configurations.Inventory.InventorySetup.Sizes
{

    public class SizeConfigration : IEntityTypeConfiguration<Size>
    {
        public void Configure(EntityTypeBuilder<Size> builder)
        {
            builder.ToTable("Size", "Inventory");
