...
{
    public class CashPayment : IRootEntity, ITenantEntity, IAuditable, ISeries
    {
        ...
        // Details
        public List<CashPaymentLine> CashPaymentLines { get; set; } = null!;
        public List<CashPaymentAdjustment> CashPaymentAdjustments { get; set; } = null!;
        public List<PurchaseInvoiceAllocation> PurchaseInvoiceAllocations { get; set; } = null!;
    }
}