...
{
    public class DebitNote : IRootEntity, ITenantEntity, IAuditable
    {
        ...
        // Discount
        public DebitNoteAdditionalDiscountType? AdditionalDiscountType { get; private set; }
        ...
        // Details
        public List<DebitNoteLine> DebitNoteLines { get; set; } = null!;
        public List<DebitNoteAdjustment> DebitNoteAdjustments { get; set; } = null!;
    }
}