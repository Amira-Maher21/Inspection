...
{
    public class SubcontractBOQ : IRootEntity, ITenantEntity, IAuditable
    {
        ...
        public string SubcontractBOQNumber { get; private set; } = string.Empty;
        public float RevisionNumber { get; private set; }
        public SubcontractBOQDocumentStatus DocumentStatus { get; private set; }
        ...
        //Details
        public virtual ICollection<SubcontractBOQLine> SubcontractBOQLines { get; set; } = null!;
    }
}