...
namespace Inspection.Domain.Models.Inventory.Transaction.InventoryAdjustments
{
    public class InventoryAdjustmentLine : IAuditable
    {
        ...
        public decimal DifferenceQty { get; private set; } // CountedQty - SystemQty
        ...
        public long GoodsTransferInId { get; private set; }
        public GoodsTransferIn GoodsTransferIn { get; private set; } = null!;
