...
{
    public interface IInspectionRequestService : IAccountServiceBase
    {

        Task<ReturnBase<InspectionRequestDto>> InsertInspectionRequestAsync(CreateInspectionRequestDto insertDto);
        Task<ReturnBase<InspectionRequestDto>> UpdateInspectionRequestAsync(UpdateInspectionRequestDto updateDto, long id);
