...
{
    public class SalesOrderDtoInclude
    {
        ...
        public decimal TaxTypePercentage { get; set; }
        ...
        public ICollection<SalesOrderLinesDto> SalesOrderLines { get; set; } = new List<SalesOrderLinesDto>();
        // series related
