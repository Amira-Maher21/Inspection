namespace Inspection.Application.Contracts.Dto.ApprovalManagement
{
    public class ApprovalInsertDto
    {
        ...
        //public IEnumerable<ApprovalDelegationInsertDto>? ApprovalDelegations { get; set; }
        public IEnumerable<ApprovalDInsertDto>? ApprovalDs { get; set; }
    ...
    //}
    public class ApprovalDInsertDto
    {
        //public long IDScrAproval { get; set; }
