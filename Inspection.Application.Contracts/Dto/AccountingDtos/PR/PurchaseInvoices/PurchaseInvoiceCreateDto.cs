...
namespace Inspection.Application.Contracts.Dto.AccountingDtos.PR.PurchaseInvoices
{
    ...
    public class PurchaseInvoiceCreateDto
    {
        ...
        public ICollection<PurchaseInvoiceLineCreateDto> InvoiceLines { get; set; } = new List<PurchaseInvoiceLineCreateDto>();
        public ICollection<PurchaseInvoiceAdjustmentCreateDto> Adjustments { get; set; } = new List<PurchaseInvoiceAdjustmentCreateDto>();
