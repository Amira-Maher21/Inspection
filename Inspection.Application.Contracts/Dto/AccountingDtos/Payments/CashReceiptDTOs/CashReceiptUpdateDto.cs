...
namespace Inspection.Application.Contracts.Dto.AccountingDtos.Payments.CashReceiptDTOs
{
    public class CashReceiptUpdateDto
    {
        ...
        public List<CashReceiptLineUpdateDto> CashReceiptLines { get; set; } = new();
        public List<CashReceiptAdjustmentUpdateDto> CashReceiptAdjustments { get; set; } = new();
        public List<SalesInvoiceAllocationUpdateDto> SalesInvoiceAllocations { get; set; } = new();
    }
}