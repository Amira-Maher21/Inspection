namespace Inspection.Application.Contracts.Dto.Inventory.Transaction.GoodsTransferInDTOs.GoodsTransferInLineDTOs
{
    public class GoodsTransferInLineUpdateDto
    {
